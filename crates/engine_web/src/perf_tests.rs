...
fn sample(frame_index: u32, total_frame_ms: f64) -> FramePerfSample {
    ...
    FramePerfSample {
        ...
        rust_cpu: RustCpuFrameTimings {
            ...
            terrain_completion_ingest_ms: total_frame_ms * 0.4,
            terrain_stream_update_ms: total_frame_ms * 0.5,
            terrain_stream_tick_ms: total_frame_ms * 0.6,
            terrain_stream_sync_ms: total_frame_ms * 0.7,
            terrain_stream_scheduler_ms: total_frame_ms * 0.8,
            terrain_stream_worker_queue_ms: total_frame_ms * 0.9,
            terrain_stream_visibility_ms: total_frame_ms,
            terrain_stream_visibility_select_ms: total_frame_ms * 1.1,
            terrain_stream_visibility_status_ms: total_frame_ms * 1.2,
            terrain_stream_visibility_apply_ms: total_frame_ms * 1.3,
            terrain_mesh_destroy_ms: total_frame_ms * 1.4,
            terrain_mesh_upload_ms: total_frame_ms * 1.5,
            render_frame_ms: total_frame_ms * 1.6,
            render_packet_build_ms: total_frame_ms * 1.7,
            renderer_prepare_ms: total_frame_ms * 1.8,
            renderer_shadow_cpu_ms: total_frame_ms * 1.9,
            renderer_scene_cpu_ms: total_frame_ms * 2.0,
            renderer_post_cpu_ms: total_frame_ms * 2.1,
            renderer_submit_ms: total_frame_ms * 2.2,
        },
