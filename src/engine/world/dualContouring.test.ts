...
describe("dualContouring", () => {
  ...
  it("clamps QEF placement to the owning cell bounds", () => {
    const intersections = [
      createIntersection(vec3(2, 0.5, 0.5), vec3(1, 0, 0)),
      createIntersection(vec3(0.5, -1, 0.5), vec3(0, 1, 0)),
      createIntersection(vec3(0.5, 0.5, 0.75), vec3(0, 0, 1))
    ];
    ...
    deepEqual(vertex, vec3(1, 0, 0.75));
  });
