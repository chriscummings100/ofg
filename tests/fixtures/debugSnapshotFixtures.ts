...
function fakeRustCpuPerfSummary(summary: NumericPerfSummary): RustCpuPerfSummary {
  return {
    ...
    terrainCompletionIngestMs: summary,
    terrainStreamUpdateMs: summary,
    terrainStreamTickMs: summary,
    terrainStreamSyncMs: summary,
    terrainStreamSchedulerMs: summary,
    terrainStreamWorkerQueueMs: summary,
    terrainStreamVisibilityMs: summary,
    terrainStreamVisibilitySelectMs: summary,
    terrainStreamVisibilityStatusMs: summary,
    terrainStreamVisibilityApplyMs: summary,
    terrainMeshDestroyMs: summary,
    terrainMeshUploadMs: summary,
