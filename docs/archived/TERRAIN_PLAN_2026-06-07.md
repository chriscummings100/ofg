...
Archived note: this historical terrain plan was replaced on 2026-06-07 by
`docs/TERRAIN_PLAN.md`, which is now the active ExecPlan for the
multi-resolution terrain view-distance phase. Keep this file for progress
history, research continuity, and migration context only.
