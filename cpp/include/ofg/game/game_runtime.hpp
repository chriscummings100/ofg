...
public:
    ...
    explicit GameRuntime(std::string disposed_message = "Game runtime has been disposed.",
    ...
    bool mark_gpu_ready(std::string adapter_name, std::string backend, std::string surface_format, std::string& error);
...
private:
    ...
    std::string m_disposed_message;
    std::string m_gpu_not_ready_message;
