...
export class RustBrowserGame {
     ...
     * @param {any} asset_loader
     * @returns {Promise<RustBrowserGame>}
     */
    static create(canvas, asset_loader) {
        const ret = wasm.rustbrowsergame_create(addHeapObject(canvas), addHeapObject(asset_loader));
    ...
    resize(viewport) {
        try {
            ...
            wasm.rustbrowsergame_resize(retptr, this.__wbg_ptr, addHeapObject(viewport));
     ...
     * @param {any} options
     */
    configureTerrainWorkers(options) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rustbrowsergame_configureTerrainWorkers(retptr, this.__wbg_ptr, addHeapObject(options));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
    ...
    takeTerrainBuildRequests() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rustbrowsergame_takeTerrainBuildRequests(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    /**
     * @param {any} completions
     * @returns {number}
     */
    completeTerrainBuilds(completions) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.rustbrowsergame_completeTerrainBuilds(retptr, this.__wbg_ptr, addHeapObject(completions));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
