---
name: review-code
description: Multi-agent code review using predefined specialist sub-agents. Use when the user explicitly asks for sub-agents, parallel review, specialist reviewers, or a deeper delegated code review of local diffs, branches, PRs, MRs, or specific files.
---
